...
import segmenter.ChineseSegment;
import segmenter.ChineseSegmentImpl;
...
public class IndexServlet extends HttpServlet {
    ...
    private ChineseSegment segment;
...
//        // 数据处理
        ...
        // 分词
        List<String> words = segment.getWordsFromInput(stockInfos);
        // 词频统计
        ...
        for (Pair<String,Double> s : maps) {
            ...
            stringBuilder.append("{\"text\":\"").append(s.getKey())
                    .append("\",\"size\":")
                    .append(linerScale(inputMin,inputMax,outputMin,outputMax,s.getValue()))
                    .append("}");
            arrays[i++] = stringBuilder.toString();
        }
    ...
    public void init() throws ServletException {
        super.init();
        segment = new ChineseSegmentImpl();
