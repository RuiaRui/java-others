...
public interface Recommend {
    ...
    List<String> GetKeyWords(StockInfo[] stocks);

    Double CosCalculator(int[] array1, int[] array2);

    int[][] FrequencyCalculator(List<String> keywords, StockInfo[] stocks);

    double[][] CosSimilarityCalculator(int[][] frequentMatrix);
}
