...
public class TF_IDFImpl implements TF_IDF {
    ...
    private static ChineseSegmenterImpl segment = new ChineseSegmenterImpl();
    ...
    public Pair<String, Double>[] getResult(List<String> words, StockInfo[] stockInfos) {
        List<List<String>> allWords = GetAllWords(stockInfos);
...
//
    /**
     * get all information from the List of aummary
     *
     * @param stockInfos
     * @return
     */
    private List<List<String>> GetAllWords(StockInfo[] stockInfos) {
        ArrayList<List<String>> allWords = new ArrayList<>();
        for (StockInfo s : stockInfos) {
            allWords.add(segment.getWordsFromData(new StockInfo[]{s}));
        }
        return allWords;
    }
//
...
//        ArrayList<List<String>> allWords = new ArrayList<>();
//        for (StockInfo s : stockInfos) {
//            allWords.add(segment.getContentFromData(new StockInfo[]{s}));
//        }
//        return allWords;
//    }
